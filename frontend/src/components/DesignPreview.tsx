...
export default function DesignPreview() {
  ...
  return (
    <section
      ...
      aria-label={t("components.designPreview.ariaLabel")}
    >
      <header className="preview-hero">
        <div>
          <p className="preview-kicker">
            {t("components.designPreview.heroKicker")}
          </p>
        ...
        <div className="preview-status-card">
          <div className="preview-pill preview-pill-blue">
            {t("status.draft")}
          </div>
          <strong>Friday Trivia Night</strong>
          <span>{t("components.designPreview.readyStatus")}</span>
          <button type="button">
            {t("components.designPreview.continueHost")}
          </button>
        </div>
      </header>
      ...
      <div className="preview-grid">
        <section className="preview-card preview-card-blue">
          <div className="preview-card-head">
            ...
            <span className="preview-tag">
              {t("components.designPreview.primaryTag")}
            </span>
          </div>
          ...
          <div className="preview-actions">
            <button type="button">
              {t("components.designPreview.createGame")}
            </button>
        ...
        <section className="preview-card preview-card-green">
          <div className="preview-card-head">
            ...
            <span className="preview-tag">
              {t("components.designPreview.setupTag")}
            </span>
          </div>
          ...
          <ul className="preview-team-list">
            <li>
              ...
              <span className="turn-badge">
                {t("components.designPreview.yourTurn")}
              </span>
            </li>
            <li>
          ...
          <div className="preview-actions">
            <button type="button">
              {t("components.designPreview.addTeam")}
            </button>
            <button type="button" className="secondary">
      ...
      <section className="preview-card preview-card-yellow preview-board-wrap">
        <div className="preview-card-head">
          ...
          <span className="preview-tag">
            {t("components.designPreview.liveGameTag")}
          </span>
        </div>
        <div className="preview-play-top">
          ...
          <div className="preview-scoreboard">
            <div className="preview-score-title">
              {t("components.designPreview.scoreboard")}
            </div>
            <ul>
      ...
      <section
        className="preview-modal-demo"
        aria-label={t("components.designPreview.questionTitle")}
      >
        <div className="preview-modal-card">
          <div className="preview-modal-top">
            <span className="preview-pill preview-pill-green">
              {t("components.designPreview.teamTurnPill")}
            </span>
            <span className="preview-pill preview-pill-yellow">
              {t("components.designPreview.pointsPill")}
            </span>
          </div>
          ...
          <div className="preview-actions">
            <button type="button">
              {t("components.designPreview.submitAnswer")}
            </button>
            <button type="button" className="secondary">
              {t("common.close")}
            </button>
          </div>
          <p className="preview-feedback success">
            {t("components.designPreview.feedbackCorrect")}
          </p>
        </div>
      </section>
    </section>
