...
export default function ScoreEventCard(props: ScoreEventCardProps) {
  ...
  return (
    <section className="card card-orange">
      ...
      <div className="grid">
        <div className="field">
          <label htmlFor="score-team">{t('components.scoreEventCard.teamLabel')}</label>
          <select id="score-team" value={scoreTeamId} onChange={(event) => onScoreTeamIdChange(event.target.value)}>
            <option value="">{t('components.scoreEventCard.selectTeam')}</option>
            {teams.map((team) => (
        ...
        <div className="field">
          <div className="field-label-row">
            <label htmlFor="score-delta">{t('components.scoreEventCard.pointsChangeLabel')}</label>
            <InfoHint text={t('components.scoreEventCard.pointsChangeHelp')} label={t('components.scoreEventCard.pointsChangeHelpLabel')} />
          </div>
          <input
            id="score-delta"
            value={scoreDelta}
        ...
        <div className="field">
          <label htmlFor="score-reason">{t('components.scoreEventCard.reasonLabel')}</label>
          <input
            id="score-reason"
            value={scoreReason}
